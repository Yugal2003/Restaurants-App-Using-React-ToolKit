...
const SignUp = () => {
  ...
  async function signUp(event){
    ...
    try {
      const dataSignUp = await createUserWithEmailAndPassword(auth,email,password); console.log(dataSignUp);
          ...
          <div className='email_password'>
              <form onSubmit={signUp}>
                  ...
                  <div className='first_last_name'>
                    ...
                    <input autocomplete="off" required type='text' placeholder='Last Name' />
                  </div>
              ...
              <p className='ptaginsignuppage'>Copyright © <NavLink to={'/'} >Restaurants.com</NavLink></p>
          </div>
      </div>
      </div>
      <Footer/>
